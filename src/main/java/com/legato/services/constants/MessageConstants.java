...
public final class MessageConstants {
	...
	public static final String INVALID_PASSWORD_FORMAT_MESSAGE = "Password must be 6-20 characters and must contain at least 1 uppercase letter, 1 lowecase letter, 1 digit and 1 special character in [@#$%]";
}